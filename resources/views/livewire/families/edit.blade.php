    ...
    <div class="card bg-white w-1/2">
        <form>
            <div class="card-header">
                <h3 class="card-title">Update Keluarga</h3>
            </div>
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div>
                        <select class="form-control" wire:model='relation'>
                            <option value="">Pilih Hubungan</option>
                                <option value="pasangan" {{ 'pasangan' == $relation ? 'selected' : '' }}>Pasangan</option>
                                <option value="anak" {{ 'pasangan' == $relation ? 'selected' : '' }}>Anak</option>
                        </select>
                    </div>
                    @error('relation')
                    <span class="text-danger">{{ $message }}</span>
            ...
            <div class="card-footer text-end">
                <button wire:click='updateFamily({{$familyId}})' class="btn btn-blue">Simpan</button>
