                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <a aria-current="page">
                                        <a class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-indigo-400 bg-white border border-gray-300 cursor-default leading-5 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400 dark:cursor-not-allowed dark:hover:text-gray-400 dark:hover:bg-white dark:hover:border-gray-300 pointer-events-none" aria-disabled="true">
                                            {{ $page }}
                                        </a>
                                    </a>
                                @else
